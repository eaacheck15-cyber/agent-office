#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Многопоточный паук-краулер офиса через пул SOCKS/HTTP прокси с ротацией.
...
def run_download():
    ...
    for ep_file in ("/root/office/output/office_endpoints.txt", "/root/office/output/office_endpoints2.txt"):
...
# Запуск: python3 office_spider.py --download <хосты>
# ════════════════════════════════════════════════════════
